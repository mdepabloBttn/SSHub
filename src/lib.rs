...
fn run_terminal_loop(
    ...
    loop {
        ...
        // to the SFTP browser and finish the edit (upload a remote working
        // copy, or refresh after an in-place local save) without requiring an
        // extra keypress on the frozen terminal screen.
        app.tick_file_edit();
